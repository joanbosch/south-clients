            ...
            <div className='flex items-center'>
              ...
              <div className='hidden md:block'>
                <div className='flex items-baseline space-x-1'>
                  <Link href='/es/admin/newClient' className='text-black hover:font-bold rounded-md px-3 py-2 text-sm font-medium' aria-current='page'>Nuevo Cliente</Link>

                  <Link href='/es/admin/clients' className='text-black hover:font-bold rounded-md px-3 py-2 text-sm font-medium'>Clientes</Link>

                  <Link href='/es/admin/newSale' className='text-black hover:font-bold rounded-md px-3 py-2 text-sm font-medium'>Nueva Venta</Link>

                  <Link href='/es/admin/sales' className='text-black hover:font-bold rounded-md px-3 py-2 text-sm font-medium'>Ventas</Link>
                </div>
              </div>
            </div>
                  ...
                  {showMenu
                    ? (
                      <div className='absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none' role='menu' aria-orientation='vertical' aria-labelledby='user-menu-button'>
                        <Link href='/es/admin/profile' className='block px-4 py-2 text-sm text-gray-700' role='menuitem' id='user-menu-item-0'>Tu perfil</Link>

                        <Link href='/es/admin/settings' className='block px-4 py-2 text-sm text-gray-700' role='menuitem' id='user-menu-item-1'>Ajustes</Link>
            ...
            <>
              ...
              <div className='md:hidden bg-white' id='mobile-menu'>
                <div className='space-y-1 px-2 pt-2 pb-3 sm:px-3'>
                  ...
                  <Link href='/es/admin/newClient' className='text-black block rounded-md px-3 py-2 text-base font-medium' aria-current='page'>Nuevo Cliente</Link>

                  <Link href='/es/admin/clients' className='text-black block rounded-md px-3 py-2 text-base font-medium' aria-current='page'>Clientes</Link>

                  <Link href='/es/admin/newSale' className='text-black block rounded-md px-3 py-2 text-base font-medium'>Nueva Venta</Link>

                  <Link href='/es/admin/sales' className='text-black block rounded-md px-3 py-2 text-base font-medium'>Ventas</Link>
                </div>
