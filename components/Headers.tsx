          ...
          <div className='flex items-center'>
            ...
            <div className='hidden md:block'>
              <div className='ml-10 flex items-baseline space-x-4'>
                <Link href='/es/dashboard' className='bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium' aria-current='page'>Dashboard</Link>
          ...
          <div className='hidden md:block'>
            <div className='ml-4 flex items-center md:ml-6'>
              ...
              <div className='relative ml-3'>
                ...
                {showMenu
                  ? (
                    <div className='absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none' role='menu' tabindex="-1" aria-orientation='vertical' aria-labelledby='user-menu-button' >
